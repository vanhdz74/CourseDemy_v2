...
const benefits = [
  {
    ...
    desc: "Nội dung thực tế, dễ áp dụng",
  },
  {
    icon: Globe2,
    title: "Học mọi lúc",
    desc: "Truy cập khóa học mọi nơi",
  },
  {
    icon: Award,
    title: "Có chứng chỉ",
    desc: "Ghi nhận sau khi hoàn thành",
  },
];
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        <div className="mx-auto mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm text-slate-200 backdrop-blur">
          ...
          Nền tảng học trực tuyến dành cho bạn
        </div>

        <h1 className="mx-auto max-w-3xl text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
          Chương trình học hướng tới mục tiêu của bạn
        </h1>

        <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-slate-300 md:text-lg">
          Khám phá các khóa học chất lượng, học theo lộ trình rõ ràng và nâng
          cấp kỹ năng của bạn nhanh hơn cùng CourseDemy.
        </p>
