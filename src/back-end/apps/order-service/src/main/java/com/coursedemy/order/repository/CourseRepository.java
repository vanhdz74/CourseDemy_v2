...
public interface CourseRepository extends JpaRepository<CourseEntity, Long>,
    ...
    @org.springframework.data.jpa.repository.Query(value = "INSERT INTO courses (id, title, price, level, quantity) VALUES (:id, :title, 0, 1, 0) ON CONFLICT (id) DO NOTHING", nativeQuery = true)
    void insertCourseIfNotExists(@org.springframework.data.repository.query.Param("id") Long id,
