...
import OverviewTab from "@/modules/course/components/course/sub-title-tab/OverviewTab";
import QATab from "@/modules/course/components/course/sub-title-tab/QATab";
import ReviewsTab from "@/modules/course/components/course/sub-title-tab/ReviewsTab";
import { Button } from "@/modules/shared/components/ui/button";
import { getCourseDetail as fetchCourseDetail } from "@repo/api";
