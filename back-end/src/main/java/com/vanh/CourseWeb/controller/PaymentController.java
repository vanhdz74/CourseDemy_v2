...
public class PaymentController {
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> createPayment(@RequestBody Map<String, Object> request,
        ...
        if (courseIds == null || courseIds.isEmpty()) {
            throw new BusinessException("COURSE_ID_EMPTY", "courseId list is empty");
        }
        ...
        if (courses.size() != ids.size()) {
            throw new BusinessException("COURSE_NOT_FOUND", "No courses found");
        }
        ...
        if ("vnpay".equalsIgnoreCase(provider) && totalPrice < 5000D) {
            throw new BusinessException("INVALID_TOTAL_PRICE", "Tổng thanh toán VNPay phải từ 5,000 VND trở lên");
        }
